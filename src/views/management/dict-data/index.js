      ...
      return [
        {
          ...
          label: '字典名称',
          default: this.dictId,
          render: () => <d2-dict-select vModel={ this.search.form.model.dict_id } name="dict_id" style="width:130px;"custom all/>
        },
        {
          prop: 'dict_label',
          label: '字典标签',
        ...
        },
        {
          ...
          label: '字典值',
          default: '',
          render: () => <el-input vModel={ this.search.form.model.dict_number } style="width:50px;" clearable/>
        },
        {
          prop: 'status',
          label: '状态',
